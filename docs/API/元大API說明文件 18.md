---
title: "元大API說明文件"
source: "https://www.yuanta.com.tw/file-repository/content/sparkapi_docs/%E8%A1%8C%E6%83%85/%E5%8F%96%E5%BE%97%E5%B7%B2%E8%A8%82%E9%96%B1%E5%8D%B3%E6%99%82%E5%A0%B1%E5%83%B9%E5%95%86%E5%93%81%E6%B8%85%E5%96%AE/index.html"
author:
published:
created: 2026-08-27
description:
...
objYuantaSparkAPI.GetQuoteList(Account);
Thread.Sleep(2000);
```
...
#取得己訂閱即時報價商品清單
objYuantaSparkAPI.GetQuoteList('S98875005091')
...
void objApi_OnResponse(int intMark, uint dwIndex, string strIndex, object objHandle, object objValue)
{
    ...
    try
    {
        ...
        if (intMark == 1)
        {
            ...
            else if (strIndex == "GetQuoteList")
            {
                var result = (SubQuoteListResult)objValue;
                try
                {
                    strResult += $"{result.Account} 己訂閱報價商品列表 筆數{result.QuoteList.Count}: \r\n";
                    result.QuoteList.ForEach(q => strResult += $"{q.MarketType},{q.StockCode};");
                }
                catch
                {
                    strResult = "";
